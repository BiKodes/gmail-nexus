# gmail-nexus
GmailNexus is a Python wrapper that simplifies Gmail API integration by managing OAuth2 authentication, email operations, and error handling for scalable applications.
...
.. code:: bash
    ...
    pip install --upgrade gmail-nexus


Setup
-----

`gmail-nexus` uses OAuth authentication
...
.. code:: python
    ...
    from nexus.crud.read import GmailAPIReadWrapper
...
**BiKodes <bikocodes@gmail.com>**


1. **_Python:**  https://www.python.org/

2. **_Tox:** https://tox.readthedocs.io/en/latest/

3. **_Pytest:** http://doc.pytest.org/en/latest/

4. **_Coverage:** https://coverage.readthedocs.io/en/coverage-4.2/

5. **_Flake8:** http://flake8.pycqa.org/en/latest/

6. **_Github:** https://github.com/BiKodes/gmail-nexus

7. **_Here:** https://developers.google.com/gmail/api/quickstart/python

8. **_GMAIL_SCOPES:** https://developers.google.com/gmail/api/auth/scopes/

9. **_permissions_granted:** https://accounts.google.com/b/0/IssuedAuthSubTokens
